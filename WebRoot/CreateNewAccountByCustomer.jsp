...
function inDate(){
  ...
  var date=new Date();
  document.newaccount.apdate.value=date.getDate()+"-"+(date.getMonth()+1)+"-"+date.getYear();
...
<form name="newaccount" action="" method="">     
<table align="center" WIDTH="500" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="green"><center><b><font color="white">CUSTOMER ACCOUNT  DETAILS</font></center></th>
      <tr rowspan="4"></tr>
...
CoreHash ch=new AccountDAO().getAllAccountTypes();
        Enumeration em1=ch.elements(); 


	            while(em1.hasMoreElements()){
             am=(AccountModel)em1.nextElement();
	                     %>
    ...
    <input type="hidden" name="custname" value="<%=cstid%>" />
   
            
     <tr>
       <td>Applied Date</td>
       <td><input type="text" name="apdate" onfocus="inDate()" value=""  /></td>
    </tr>
