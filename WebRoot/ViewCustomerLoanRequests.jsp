...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="green">
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));%></strong> </span> 
      ...
      try{
     CoreHash ch=new LoanDAO().getAllCustLoanRequests();
 ...
 <table align="center" WIDTH="600" border="0" bordercolor="block" bgcolor="">         
      ...
      <tr>
        ...
        <%   while(em.hasMoreElements()){
             am=(LoanModel)em.nextElement(); %>    
        <tr> 
            <td value="<%=am.getCustid()%>"><%=am.getCustname()%> </td>  
            <td value="<%=am.getLoantypeid()%>"><%=am.getLoantypename()%></td>
            <td><%=am.getApplydate()%></td>  
            <td value=""><a href="CustLoanAccept.jsp?custid=<%=am.getCustid()%>">Accept</a></td>
            <td value=""><a href="CustLoanReject.jsp?custid=<%=am.getCustid()%>">Reject</a></td>
