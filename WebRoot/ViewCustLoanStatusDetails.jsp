...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="green">
      <th colspan="15" bgcolor=""><center><b><font color="white">CUSTOMER LOAN ISSUE STATUS DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));%></strong> </span> 
      ...
      CoreHash ch=new LoanDAO().getCustLoanStatusDetails(custid);
