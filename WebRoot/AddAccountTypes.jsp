...
<form method="" action="./AccountTypesAction" name="rigister" onSubmit="return validate()"> 
     ...
     <center> 
      ...
      <th colspan="15" bgcolor="green"><center><b><font color="white" >ACCOUNT TYPE DETAILS</font></center></th>
      <tr rowspan="4"></tr>
                         
 
<tr><td>Account Types</td>
<td>
<select  name="accountypes">
<option value="select">-select-</option>
<option value="Current Account">Current Account</option>
<option value="Saving  Account">Saving Account</option>
<option value="Recuring Account">Recuring Account</option>
</select></td>
</tr><br/>
  

<tr><td>Min&nbsp;Diposite&nbsp;Amount</td><td><input type="text" name="minamt"></td></tr><br>

<tr><td>Period In Months</td><td><input type="text" name="period"></td></tr><br>

<tr><td>Intrest Rate</td><td><input type="text" name="rate"></td></tr><br>

<%--  <tr><td>Status</td><td><input type="text" name="status"></td></tr><br>--%>
   <tr><td><input type="submit" name="submit" value="Add Account Type"></td><td><input type="reset" name="clear" value="Clear"></td></tr><br/>
