...
<FORM name="" action="ViewCustomerLoanRequests.jsp" method="">
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="green">
      <th colspan="15" bgcolor=""><center><b><font color="white">CUSTOMER LOAN REQUEST DETAILS</font></center></th>
      <tr rowspan="4"></tr>
...
String target="ViewCustomerLoanRequests.jsp?status=Invalid";
       try{
           
         
           boolean flag=new LoanDAO().RejectCustLoanRequestDetails(custid);
          
       if(flag)
          target="ViewCustomerLoanRequests.jsp?status=Rejected";
       else
          target="ViewCustomerLoanRequests.jsp?status=Rejected";
