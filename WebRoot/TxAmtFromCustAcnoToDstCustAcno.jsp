...
<form method="" action="./TransferAction" name="transamount" onSubmit="return validate()"> 
     ...
     <center> 
      ...
      <th colspan="15" bgcolor="green"><center><b><font color="white" >Transfer Amount To destination Account</font></center></th>
      <tr rowspan="4"></tr>
  ...
  <%    CustomerModel  cm=null;
       ...
       <tr><td>From&nbsp;Account&nbsp;No</td><td><input type="text" name="saccno" value="<%=custacno%>"></td></tr><br>
       <tr><td>To&nbsp;Account&nbsp;No</td><td><input type="text" name="daccno" value=""></td></tr><br>
       <tr><td>Pin&nbsp;No</td><td><input type="password" name="pinno"  value=""   ></td></tr><br>
       <tr><td>Amount&nbsp;To&nbsp;Be&nbsp;Transfered</td><td><input type="text" name="transferamt"  value=""></td></tr><br>

   <tr><td><input type="submit" name="submit" value="Transfer Amount"></td><td><input type="reset" name="clear" value="Clear"></td></tr><br/>
