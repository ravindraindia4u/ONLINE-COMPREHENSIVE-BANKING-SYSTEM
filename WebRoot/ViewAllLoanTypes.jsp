...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="green">
 ...
 <table align="center" WIDTH="600" border="0" bordercolor="block" bgcolor="">         
      ...
      <tr>
        ...
        <tr>   
            <td value="<%=am.getLoantypeid()%>"><a href="SeeLoanTypeDetails.jsp?loantypeid=<%=am.getLoantypeid()%>"><%=am.getLoantypename()%> </a></td>
            <td><%=am.getIntrestrate()%></td>     
            <td><%=am.getPeriods()%></td> 
            <td><%=am.getInstlamtpermonth()%></td>  
            <td><%=am.getNoterms()%></td>     
            <td><%=am.getStatus()%></td>
            <td><%=am.getLoanamount()%></td> 
        </tr>
        <%} %>
   </table>
    <%}catch(Exception e)
