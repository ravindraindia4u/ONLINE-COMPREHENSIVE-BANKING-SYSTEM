...
<FORM  name=""  action="./AccountTypesAction" method="">
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="green">
      <th colspan="15" bgcolor=""><center><b><font color="white">ACCOUNT ACTIVATE DETAILS</font></center></th>
      <tr rowspan="4"></tr>
...
<% try{AccountModel  am=null;
CoreHash ch=new AccountDAO().getAllDeactiveAccountTypes();
   ...
   <center>
      <input type="submit" name="submit" value="Active"/>  </center>
