...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="green">
      <th colspan="15" bgcolor=""><center><b><font color="white">ACCOUNT  DETAILS</font></center></th>
      <tr rowspan="4"></tr>
 ...
 <table align="center" WIDTH="650" border="0" bordercolor="block" bgcolor="">         
      ...
      <tr>
        ...
        <%while(em.hasMoreElements()){
             am=(AccountModel)em.nextElement(); %>
        <tr>   
            <td value="<%=am.getAcountypeid()%>"><a href="SeeAcountTypeDetails.jsp?acounttypeid=<%=am.getAcountypeid()%>"><%=am.getAcounttypename()%> </a></td>
            <td><%=am.getMindeposteamt()%></td>     
            <td><%=am.getPeriods()%></td> 
            <td><%=am.getIntrestrate()%></td>    
            <td><%=am.getStatus()%></td> 
        </tr>
        <%}%>
   </table>
