...
<form name="modcustomerprofile" action="./AddCustomerAction" method="">     
<table align="center" WIDTH="500" border="0" bordercolor="black" bgcolor="#F4F5F7">
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
              ...
              String addressprofs=getServletContext().getRealPath("/addressprofs");
                ...
                int cid=Integer.parseInt(request.getParameter("custid").trim());
                String loginname=(String)session.getAttribute("user"); 
String role=(String)session.getAttribute("role");


             //   out.println("-----------------------loginname------"+loginname);
               // em=new CustomerDAO().getPerCustIDBYName(loginname);
               //int custid=em.getCustid();
       try{
      
       em=new CustomerDAO().getPerticularCustProfile(images,addressprofs,cid);
         
          
         %> 
                  
        <tr>
    <input type="hidden" name="cid" value="<%=em.getCustid()%>"/>
     <td>Cust Name </td>
    ...
    <td><input type="text" name="addrs" value="<%=em.getAddress()%>" /></td>
             ...
             <tr>
    <td>E Mail</td>
    <td><input type="text" name="email" value="<%=em.getEmailid()%>" /></td>
    </tr>
...
<option value="UnMarried">UnMarried</option>
    ...
    <tr>
    <td>User Name</td>
    <td><input type="text" name="username" value="<%=em.getCustuname()%>"  readonly/></td>
    </tr> 
        
         
         <tr>
    <td>Password </td>
    <td><input type="text" name="password" value="<%=em.getCustpass()%>" readonly/></td>
    </tr>
    ...
    <tr><td>Cust.Photo </td><td><input type="file"  name="photo"   value="<%=em.getCustid()%>.gif " /><img src="userimages/<%=em.getCustid() %>.gif" height=30 width=50></td></tr>
   
       <tr><td>Cust.AddProf </td><td><input type="file"  name="addrsprof"   value="<%=em.getCustid()%>.gif " /><img src="addressprofs/<%=em.getCustid() %>.gif" height=30 width=50></td></tr>
