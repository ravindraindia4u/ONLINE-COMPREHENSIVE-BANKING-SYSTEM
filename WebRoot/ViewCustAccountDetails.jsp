...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="green">
      <th colspan="15" bgcolor=""><center><b><font color="white">CUSTOMER ACCOUNT DETAILS</font></center></th>
      <tr rowspan="4"></tr>
 ...
 <table align="center" WIDTH="650" border="0" bordercolor="block" bgcolor="">         
    ...
    <td value="<%=am.getAcountypeid()%>"><%=am.getAcounttypename()%> </td>
    <td ><%=am.getAccountno()%> </td>    
    <td><%=am.getApplydate()%></td> 
    <td><%=am.getIssuedate()%></td> 
    <td><%=am.getNomineename()%></td> 
  </tr>
   </table>
    <%}catch(Exception e)
{e.printStackTrace();}%> 
