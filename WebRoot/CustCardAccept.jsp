...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="green">
      <th colspan="15" bgcolor=""><center><b><font color="white">CUSTOMER CARD ACCEPT DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));%></strong> </span> 
              ...
              String addressprofs=getServletContext().getRealPath("/addressprofs");
               ...
               String target="ViewAllCustomerCardsRequests.jsp?status=Invalid";
       try{
           
         
           boolean flag=new CardDAO().AcceptCustCardRequestDetails(custid);
          
       if(flag)
          target="ViewAllCustomerCardsRequests.jsp?status=Accepted";
       else
          target="ViewAllCustomerCardsRequests.jsp?status=Rejected";
