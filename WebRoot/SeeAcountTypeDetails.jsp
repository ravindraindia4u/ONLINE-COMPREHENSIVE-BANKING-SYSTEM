...
<form name="" action="./ChangeAccountTypeDetails" method="">     
<table align="center" WIDTH="500" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="green"><center><b><font color="white">ACCOUNT  DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
                ...
                <%
                 AccountModel  em=null;
              
                int actypeid=Integer.parseInt(request.getParameter("acounttypeid").trim());
               
       try{
      
       em=new AccountDAO().getPerticularAccountTypes(actypeid);
         
          
         %> 
                  
        <tr>
    <input type="hidden" name="actid" value="<%=em.getAcountypeid()%>"/>
     <td>Account Type Name </td>
    <td><input type="text"  name="actname"  value="<%=em.getAcounttypename()%>" readonly /></td>
     </tr>
     
      <tr>
    <td>Min Amount</td>
    <td><input type="text" name="minamt" value="<%=em.getMindeposteamt()%>" /></td>
    </tr>
    ...
    <td><input type="text" name="period" value="<%=em.getPeriods()%>" readonly /></td>
     ...
     <tr>
    <td>Intrest Rate</td>
    <td><input type="text" name="intrestrate" value="<%=em.getIntrestrate()%>" /></td>
    </tr>
                
<%--  <tr>--%>
<%--    <td>State</td>--%>
<%--    <td><input type="text" name="state" value="<%=em.getStatus()%>" readonly /></td>--%>
<%--    </tr>--%>
<%--    --%>
