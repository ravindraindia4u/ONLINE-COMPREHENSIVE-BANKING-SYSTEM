...
<form name="" action="./LoanTypesAction" method="">     
<table align="center" WIDTH="500" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="green"><center><b><font color="white">LOAN  DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
                ...
                <%
                 LoanModel  em=null;              
                int loantypeid=Integer.parseInt(request.getParameter("loantypeid").trim());
               
       try{
      
       em=new LoanDAO().getPerticularLoanTypes(loantypeid);
         
          
         %> 
                  
        <tr>
    <input type="hidden" name="lntid" value="<%=em.getLoantypeid()%>"/>
     <td>Account Type Name </td>
    <td><input type="text"  name="lntname"  value="<%=em.getLoantypename()%>" readonly /></td>
     </tr>
     
      <tr>
    <td>Intrest Rate</td>
    <td><input type="text" name="irate" value="<%=em.getIntrestrate()%>" /></td>
    </tr>
          
      <tr>
    <td>Peroid</td>
    <td><input type="text" name="period" value="<%=em.getPeriods()%>" readonly /></td>
    </tr>
     
     <tr>
    <td>Instalment </td>
    <td><input type="text" name="instalment" value="<%=em.getInstlamtpermonth()%>" /></td>/Month
    </tr>
          
          
   <tr>
    <td>Terms </td>
    <td><input type="text" name="terms" value="<%=em.getNoterms()%>" /></td>
   </tr> 
   
     <tr>
    <td>Loan Amount </td>
    <td><input type="text" name="loanamt" value="<%=em.getLoanamount()%>" /></td>
   </tr> 
...
{e.printStackTrace();}%> 
 ...
 <tr rowspan="1"></tr><tr rowspan="1"></tr><tr rowspan="1"></tr><tr rowspan="1"></tr>
      ...
      <input type="submit" name="submit" value="Modify Loan Details"/>
