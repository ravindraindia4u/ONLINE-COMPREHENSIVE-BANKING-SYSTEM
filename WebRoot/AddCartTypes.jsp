...
<form method="" action="./CardTypeAction" name="cardtype" onSubmit="return validate()"> 
     ...
     <center> 
      ...
      <th colspan="15" bgcolor="green"><center><b><font color="white" >CARD TYPE DETAILS</font></center></th>
      <tr rowspan="4"></tr>
                         
 
<tr><td>Card Types Name</td><td><input type="text" name="ctypename"></td></tr><br>

<tr><td>Min.Balance</td><td><input type="text" name="mnbal"></td></tr><br>

   <tr><td><input type="submit" name="submit" value="Add Card Type"></td><td><input type="reset" name="clear" value="Clear"></td></tr><br/>
