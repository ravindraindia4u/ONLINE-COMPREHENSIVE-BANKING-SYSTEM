...
<TD style="border:0;">
	...
	<TBODY><TR>
	<TD valign="top" bgcolor="#492dd9"><IMG src="./myimages/banner_top.jpg" border="1" width="1255" height="200"></TD>
	</TR>
	<TR>
...
<TABLE cellpadding="0" cellspacing="0" width="550" class="Middle">
	...
	<td height="20" colspan="1200" class="navText style1" id="navigation">	 
...
<table width="1025" height="22">

<TR>
                <TD vAlign=center align=left width=698 height=16><FONT 
                  color=#003399><STRONG><FONT size=1>
                  <MARQUEE scrollDelay=250 style="margin: 0pt 526.45px; display: -moz-box;"><FONT color=#cc6600>Weblocker Call Center 
...
<form action="./LoginAction" method="post" name="register" onSubmit="return validate()">
    ...
    <tr>
        <td align="center" colspan="2">
            <img src="images/Photo4.jpg" border="2" align="absbottom"/>&nbsp;
    ...
    <tr>       
        <td align="left"><input type="submit" name="submit" value="Login" /><input type="reset" name="submit" value="Clear" /></td>
    </tr>                   
