...
<FORM name="" action="ChangeCustomerStatusDetails.jsp" method="">
...
String target="ChangeCustomerStatusDetails.jsp?status=Invalid";
       try{
           
         
           boolean flag=new CustomerDAO().AcceptCustomersRequestDetails(custid);
          
       if(flag)
          target="ChangeCustomerStatusDetails.jsp?status=Accepted";
       else
          target="ChangeCustomerStatusDetails.jsp?status=Rejected";
