...
<form name="" action="./CardTypeAction" method="">     
<table align="center" WIDTH="500" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="15" bgcolor="green"><center><b><font color="white">CARD DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
                ...
                int cardtypeid=Integer.parseInt(request.getParameter("cardtypeid").trim());
               
       try{      
       em=new CardDAO().getPerticularCardTypesDetails(cardtypeid);
           %> 
                  
        <tr>
    <input type="hidden" name="crtypid" value="<%=em.getCardtypeid()%>"/>
     <td>Cart Type Name </td>
    <td><input type="text"  name="crttname"  value="<%=em.getCardtypename()%>" readonly /></td>
     </tr>
     
      <tr>
    <td>Min Amount</td>
    <td><input type="text" name="minamt" value="<%=em.getMinbal()%>" /></td>
    </tr>
...
{e.printStackTrace();}%> 
 ...
 <tr rowspan="1"></tr><tr rowspan="1"></tr><tr rowspan="1"></tr><tr rowspan="1"></tr>
      ...
      <input type="submit" name="submit" value="Modify Card Type Details"/>
