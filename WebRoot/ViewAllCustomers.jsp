...
<table align="center" WIDTH="850" border="0" bordercolor="black" bgcolor="green">
      <th colspan="15" bgcolor=""><center><b><font color="white">LOAN  DETAILS</font></center></th>
      <tr rowspan="4"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));%></strong> </span> 
      ...
      try{
     CoreHash ch=new CustomerDAO().getAllCustProfile(images,addressprofs);
 ...
 <table align="center" WIDTH="800" border="0" bordercolor="block" bgcolor="">         
      ...
      <tr>
        ...
        <table align="center" WIDTH="800" border="0" bordercolor="black" bgcolor="">
        <%   while(em.hasMoreElements()){
             am=(CustomerModel)em.nextElement(); %>    
        <tr>   
            <td value="<%=am.getCustid()%>"><%=am.getCustfname()%></td>
            <td><%=am.getDob()%></td>     
            <td><%=am.getDoj()%></td> 
            <td><%=am.getPhno()%></td>  
            <td><%=am.getEmailid()%></td>     
            <td><%=am.getAddress()%></td>
            <td><%=am.getCustuname()%></td>     
            <td><%=am.getCustpass()%></td>
            <td value="<%=am.getCustid()%>.gif"><img src="userimages/<%=am.getCustid()%>.gif" height=30 width=50></td>
   <td value="<%=am.getCustid()%>.gif"><img src="addressprofs/<%=am.getCustid()%>.gif" height=30 width=50></td>
