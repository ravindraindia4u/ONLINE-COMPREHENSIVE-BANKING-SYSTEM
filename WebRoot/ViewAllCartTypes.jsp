...
<table align="center" WIDTH="650" border="0" bordercolor="black" bgcolor="green">
      <th colspan="15" bgcolor=""><center><b><font color="white">VIEW ALL CARD DETAILS</font></center></th>
      <tr rowspan="4"></tr>
 ...
 <table align="center" WIDTH="600" border="0" bordercolor="block" bgcolor="">         
      ...
      <tr>
        ...
        <tr>   
            <td value="<%=am.getCardtypeid()%>"><a href="SeeCardTypeDetails.jsp?cardtypeid=<%=am.getCardtypeid()%>"><%=am.getCardtypename()%> </a></td>
            <td><%=am.getMinbal()%></td>                
            <td><%=am.getStatus()%></td>          
        </tr>
        <%} %>
