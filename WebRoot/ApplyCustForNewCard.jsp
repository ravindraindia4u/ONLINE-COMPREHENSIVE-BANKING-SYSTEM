...
<%@page import="com.dts.project.dao.CardDAO"%>
<%@page import="com.dts.project.model.CardModel"%>
...
function inDate(){
  ...
  var date=new Date();
  document.applyfornewcard.apdate.value=date.getDate()+"-"+(date.getMonth()+1)+"-"+date.getYear();
...
<form method="" action="./CardTypeAction" name="applyfornewcard" onSubmit="return validate()"> 
     ...
     <center> 
      ...
      <th colspan="15" bgcolor="green"><center><b><font color="white" >APPLY CUSTOMER CARD DETAILS</font></center></th>
      <tr rowspan="4"></tr>
...
<tr><td>Card Type</td><td><select size="1" name="cardtype">
<option value="select">-Select-</option>
 <% CoreHash ch=new CardDAO().getAllCardTypesDetails();
	             Enumeration em=ch.elements();
	             CardModel p=null;
	             while(em.hasMoreElements()){
	                   p=(CardModel)em.nextElement();                 
	                   
	                  %>
                    <option  value="<%=p.getCardtypeid()%>"><%=p.getCardtypename()%></option>
                    <%} %>
</select>
</td></tr><br/>
  
<tr><td>Account No</td><td><input type="text" name="accno" value="<%=custacno%>"></td></tr><br>
<tr><td>Apply Date</td><td><input type="text" name="apdate" onfocus="inDate()" value=""></td></tr><br>

<input type="hidden" name="custid" value="<%=custid%>"/>


   <tr><td><input type="submit" name="submit" value="Apply For Card"></td><td><input type="reset" name="clear" value="Clear"></td></tr><br/>
