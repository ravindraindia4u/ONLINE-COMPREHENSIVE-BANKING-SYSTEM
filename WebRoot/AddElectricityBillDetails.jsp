...
function inDate(){
  ...
  var date=new Date();
  document.electricity.paydate.value=date.getDate()+"-"+(date.getMonth()+1)+"-"+date.getYear();
...
function issueDate(){
  ...
  var date=new Date();
  document.electricity.issuedate.value=(date.getDate())+"-"+(date.getMonth()+1)+"-"+date.getYear();
  document.getElementById('exprId').innerHTML=0;
}
...
function goOn() {
var port=document.electricity.port.value;
var host=document.electricity.host.value;
var sno=document.electricity.sno.value;
window.location.href='http://'+host+':'+port+'/WEBLOCKER2/GetDueAmtAction?sno='+sno;
...
function ValidatePnoneNumber(){
 ...
 function getBill(){
var dueamt=document.electricity.dueamt.value;
var preading=document.electricity.preading.value;
var prvreading=document.electricity.prvreading.value;
var cost=document.electricity.cost.value;

document.electricity.amt2pay.value=parseInt((preading-prvreading)*cost)+parseInt(dueamt);
...
if(preading>=prvreading)
alert('ok');
else
alert('preading should be grater than previous reading');
...
<%--	<TR>	--%>
 ...
 <form method="" action="./ElectricityAction" name="electricity" onSubmit="return validate()"> 
    
    <table align="center" WIDTH="430" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="2" bgcolor="#a4c2c2"><center><b><font color="white">Electricity Bill Details</font></center></th>
      <tr rowspan="5"></tr>
      <tr>
    <td>
     <center>  </center>
...
String image=getServletContext().getRealPath("/userimages");
 ...
 CustomerModel cmodel=null;
   ...
   %>
  <tr><td>  Section No</td><td><input type="text" name="sno" onblur="goOn()" value="<%if(request.getParameter("ssno")!=null)out.println(request.getParameter("ssno")); else out.println("");%>"></td></tr><br>
 
<%-- <tr><td>  Security No</td><td><input type="text" name="secureno"></td></tr><br>--%>
 
 <tr><input type="hidden" name="ccustid" value="<%=cid%>" readonly />
    <td>Customer Name</td>
    <td><input type="text" name="custname" value="<%=cname%>" readonly /></td>
    </tr>
 
 <tr><td>  Previous Reading</td><td><input type="text" name="prvreading" value="<%=request.getParameter("prereading")%>" readonly ></td></tr><br>
 <tr><td>  Present Reading</td><td><input type="text" name="preading" onfocus="checkreadings()"></td></tr><br>
 
 <tr><td> Cost/Unit</td><td><input type="text" name="cost" value="2"></td></tr><br>
  
  
  <tr><td> Due Amt</td><td><input type="text"  name="dueamt" value="<%=request.getParameter("damt")%>" readonly ></td></tr><br>
<%-- <tr><td> Due Amt</td><td><input type="text"  name="dueamt" value="<%=if(request.getParameter("damt")!=null) out.println(request.getParameter("damt"));else out.println("");%>" readonly ></td></tr><br>--%>
 
  <tr><td> Amount To Pay</td><td><input type="text" name="amt2pay"  onfocus="getBill()"></td></tr><br>
  <tr><td> Payed Amount</td><td><input type="text" name="payamt"></td></tr><br>
  
  <tr><td> Bill Issue Date</td><td><input type="text"  onfocus="issueDate()" name="issuedate"></td></tr><br>
 
 <tr><td>  Bill Pay Date</td><td><input type="text"  onfocus="inDate()" name="paydate"></td></tr><br>
 
 
  <tr><td> Electricity Type</td><td><select  name="etype">
...
var frmvalidator  = new  Validator("electricity");
    
  frmvalidator.addValidation("payamt","req","Please Enter  Amount");
  frmvalidator.addValidation("preading","req","Please Enter Present Reading");
  frmvalidator.addValidation("secureno","req","Please Enter Security Number");  
