...
function goOn() {
var port=document.custwithdraw.port.value;
alert('--------port'+port);
var host=document.custwithdraw.host.value;
alert('--------host'+host);
var pinno=document.custwithdraw.pinno.value;
alert('--------pinno'+pinno);
var cid=document.custwithdraw.custid.value;
alert('--------cid'+cid);

window.location.href='http://'+host+':'+port+'/WEBLOCKER2/ChekCustPinAction?pin='+pinno+'&custid='+cid;
...
<script type="text/javascript"> 
    ...
    */ 
    ...
    var pinno=document.custwithdraw.pinno.value;
    var cid=document.custwithdraw.custid.value;
    var url='http://'+host+':'+port+'/WEBLOCKER2/ChekCustPinAction?pin='+pinno+'&custid='+cid;
    
<%--        var url = 'http://localhost:8081/MYAJAX/GetAuthorsProfile?author='+authorSelected; --%>
...
<form method="get" action="./TransferAction" name="custwithdraw" onSubmit="return validate()"> 
     ...
     <center> 
      ...
      <th colspan="15" bgcolor="green"><center><b><font color="white" >CUST WTITHDRAW DETAILS</font></center></th>
      <tr rowspan="4"></tr>
 ...
 <input type="hidden" name="host" value="<%=request.getServerName() %>"/>
    ...
    <tr><td>Withdraw&nbsp;Amount</td><td><input type="text" name="withdrawamt"  value=""></td></tr><br>
    <tr><td>Pin&nbsp;No</td><td><input type="text" name="pinno"  value=""   ></td></tr><br>
    <tr><td><input type="submit" name="submit" value="Withdraw Amount" ></td><td><input type="reset" name="clear" value="Clear"></td></tr><br/>
  </TABLE> 
   </form>
    
   

<%--   <% int ppin=Integer.parseInt(request.getParameter("pin"));--%>
<%--    int ccid=Integer.parseInt(request.getParameter("ccid"));--%>
<%--    int cacno=Integer.parseInt(request.getParameter("custaccno"));--%>
<%--     if(ppin==Integer.parseInt(request.getParameter("pinno"))){--%>
<%--     %>--%>
<%--     <script>--%>
