...
<form method="" action="./LoanTypesAction" name="rigister" onSubmit="return validate()"> 
     ...
     <center> 
      ...
      <th colspan="15" bgcolor="green"><center><b><font color="white" >LOAN TYPE DETAILS</font></center></th>
      <tr rowspan="4"></tr>
                         
 
<tr><td>Loan Types Name</td><td><input type="text" name="loantypename" value=""></td></tr><br/>  
<tr><td>Intrest&nbsp;Rate</td><td><input type="text" name="rate"></td></tr><br>
<tr><td>No&nbsp;Period</td><td><input type="text" name="period"></td></tr><br>
<tr><td>Instal&nbsp;Amount&nbsp;Per&nbsp;Month</td><td><input type="text" name="instamt"></td></tr><br>
<tr><td>No&nbsp;Of&nbsp;Terms</td><td><input type="text" name="terms"></td></tr><br>
<tr><td>Loan&nbsp;Amount</td><td><input type="text" name="loanamt"></td></tr><br>



<%--  <tr><td>Status</td><td><input type="text" name="status"></td></tr><br>--%>
   <tr><td><input type="submit" name="submit" value="Add Loan Type"></td><td><input type="reset" name="clear" value="Clear"></td></tr><br/>
