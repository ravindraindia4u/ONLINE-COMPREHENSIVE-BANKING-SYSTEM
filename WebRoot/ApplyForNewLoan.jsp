...
<form method="" action="./LoanTypesAction" name="" onSubmit="return validate()"> 
     ...
     <center> 
      ...
      <th colspan="15" bgcolor="green"><center><b><font color="white" >CUSTOMER LOAN DETAILS</font></center></th>
      <tr rowspan="4"></tr>
...
<tr><td>Loan Type</td><td><select size="1" name="loantype">
<option value="select">-Select-</option>
 <% CoreHash ch=new LoanDAO().getAllLoanTypesDetails();
	             Enumeration em=ch.elements();
	             LoanModel p=null;
	             while(em.hasMoreElements()){
	                   p=(LoanModel)em.nextElement();                 
	                   
	                  %>
                    <option  value="<%=p.getLoantypeid()%>"><%=p.getLoantypename()%></option>
                    <%} %>
</select>
</td></tr><br/>
...
<input type="hidden" name="custid" value="<%=custid%>">
   ...
   <tr><td><input type="submit" name="submit" value="Apply For Loan"></td><td><input type="reset" name="clear" value="Clear"></td></tr><br/>
