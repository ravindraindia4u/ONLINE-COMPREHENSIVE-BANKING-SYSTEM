...
function inDate(){
  ...
  var date=new Date();
  document.telephone.stdate.value=date.getDate()+"-"+(date.getMonth()+1)+"-"+date.getYear();
...
window.location.href='http://'+host+':'+port+'/CITIZENCARD/GetDueAmtAction?sno='+sno;
...
function ValidatePnoneNumber(){
 ...
 function ttamt(){
var stdate=document.insurence.stdate.value;

var enddate=document.insurence.enddate.value;

var usrDate = new Date(stdate);
...
if(usrDate.getDate() > curDate.getDate())
 diffMonths--;
var amtformonth=document.insurence.amtformonth.value;
document.insurence.gttamt.value=parseInt(diffMonths)*parseInt(amtformonth);
...
document.insurence.terms.value=parseInt(diffMonths);
...
<%--	<TR>	--%>
 ...
 <form method="" action="./TelephoneAction" name="telephone" > 
 ...
 <input type="hidden" name="host" value="<%=request.getServerName() %>"/>
   ...
   <tr><td> Phone  Type</td><td><input type="text"  name="ttypename" value=""></td></tr><br>
   <tr><td>  Amount /Min</td><td><input type="text" name="amtformin"></td></tr><br>
   <tr><td> Other Taxes</td><td><input type="text"   name="taxes"></td></tr><br>
   <tr><td>Issue Date</td><td><input type="text" name="stdate" onfocus="inDate()"  value=""></td></tr><br>
  
  <tr><td><input type="submit" name="submit"   value="Add Telephone Types"></td><td><input type="reset" name="clear" value="Clear"></td></tr><br>
